...
df_correlation_test = pd.read_csv('/exports/humgen/idenhond/data/evaluate_correlation/correlation_per_track_test_own_output_newmodel.csv', index_col = 0, names = col_name)
col_name = ['correlation validation']
df_correlation_validation = pd.read_csv('/exports/humgen/idenhond/data/evaluate_correlation/correlation_per_track_valid_own_output_newmodel.csv', index_col = 0, names = col_name)
...
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_newmodel_boxplot_test_val_corr.png', bbox_inches='tight')

plt.figure(2)
plt.ylabel('Pearson Correlation Coefficient')
sns.violinplot(data = df[['test correlation', 'validation correlation']], orient = 'v')
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_newmodel_violinplot_test_val_corr.png', bbox_inches='tight')
...
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_newmodel_scatterplot_test_val_corr.png', bbox_inches='tight')

plt.figure(4)
plt.axline((0, 0), (1, 1), linewidth=0.5, color='k', linestyle = 'dashed')
sns.scatterplot(data = df, x = 'test correlation', y = 'validation correlation', hue = 'assay type')
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_newmodel_scatterplot_test_val_corr_asssaytype.png', bbox_inches='tight')
...
for key, value in df['assay type'].value_counts().to_dict().items():
    ...
    plt.savefig(f'/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_newmodel_scatterplot_test_val_corr_{key}.png', bbox_inches='tight')