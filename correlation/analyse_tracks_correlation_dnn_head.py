...
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/dnn_head_boxplot_test_vsenformer_corr.png', bbox_inches='tight')

plt.figure(2)
sns.boxplot(data = df['test correlation'], showmeans = True)
    # boxplot for multiple numerical columns
plt.ylabel('Pearson Correlation Coefficient')
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/dnn_head_boxplot_test_corr.png', bbox_inches='tight')
...
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/dnn_head_scatterplot_test_enformer_corr.png', bbox_inches='tight')

plt.figure(4)
plt.axline((0, 0), (1, 1), linewidth=0.5, color='k', linestyle = 'dashed')
sns.scatterplot(data = df, x = 'test correlation enformer', y = 'test correlation', hue = 'assay type')
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/dnn_head_scatterplot_test_enformer_corr_asssaytype.png', bbox_inches='tight')

exit()
plt.figure(2)
plt.ylabel('Pearson Correlation Coefficient')
sns.violinplot(data = df[['test correlation', 'validation correlation']], orient = 'v')
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_pretrainedmodel_violinplot_test_val_corr.png', bbox_inches='tight')
...
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_pretrainedmodel_scatterplot_test_val_corr.png', bbox_inches='tight')

plt.figure(4)
plt.axline((0, 0), (1, 1), linewidth=0.5, color='k', linestyle = 'dashed')
sns.scatterplot(data = df, x = 'test correlation', y = 'validation correlation', hue = 'assay type')
plt.savefig('/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_pretrainedmodel_scatterplot_test_val_corr_asssaytype.png', bbox_inches='tight')
...
for key, value in df['assay type'].value_counts().to_dict().items():
    ...
    plt.savefig(f'/exports/humgen/idenhond/projects/enformer/correlation/Plots/own_output_pretrainedmodel_scatterplot_test_val_corr_{key}.png', bbox_inches='tight')