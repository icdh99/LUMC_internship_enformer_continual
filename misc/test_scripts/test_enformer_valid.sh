...
#SBATCH --gres=gpu:1
#SBATCH --mem=90G
#SBATCH --output=/exports/humgen/idenhond/enformer_dev/enformer-pytorch/Reports/output.%j.out # STDOUT

script=/exports/humgen/idenhond/enformer_dev/enformer-pytorch/scripts/test_scripts/test_enformer_valid.py
