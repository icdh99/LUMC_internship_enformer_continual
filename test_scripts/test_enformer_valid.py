...
ds = GenomeIntervalDataset(
    ...
    shift_augs = None,                               # random shift augmentations from -2 to +2 basepairs --> even checken wat dit doet
...
for i in range(length):
    ...
    print(f"Datatype of tensor embeddings: {embeddings.dtype}") #float32
...
print('comparison of shape and datatypes')
print(f"Shape of big tensor embeddings option 1: {embeddings_opt1.shape}")
print(f"Shape of big tensor output option 1: {output_opt1.shape}")

print(f"dtype of big tensor embeddings option 1: {embeddings_opt1.dtype}")
print(f"dtype of big tensor output option 1: {output_opt1.dtype}")
...
print(f"dtype of big tensor embeddings option 2: {embeddings_tensor_opt2.dtype}")
print(f"dtype of big tensor output option 2: {output_tensor_opt2.dtype}")
print('\n')
print(output_tensor_opt2 == output_opt1)
print(embeddings_tensor_opt2 == embeddings_opt1)
print(torch.eq(output_tensor_opt2, output_opt1))
print('\n')
print(torch.eq(embeddings_tensor_opt2, embeddings_opt1))
print('\n')
print(torch.allclose(output_tensor_opt2, output_opt1))
print('\n')
print(torch.allclose(embeddings_tensor_opt2, embeddings_opt1))
print('\n')
