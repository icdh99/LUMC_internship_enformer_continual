...
plt.savefig('Intersect_14E_test_lengths.png')
plt.close()

plt.figure()
sns.histplot(data = df[df['length'] >= 256], x = 'length')
plt.savefig('Intersect_14E_test_lengths_above256.png')
plt.close()
...
plt.savefig('Intersect_14E_test_chr_counts.png', bbox_inches = 'tight')
plt.close()