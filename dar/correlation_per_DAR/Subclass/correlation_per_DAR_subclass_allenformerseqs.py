...
df = pd.read_csv('/exports/humgen/idenhond/data/DAR/Subclass_level/Subclass_neuronal_14E.bed', sep = '\t', names = ['chr', 'start', 'stop', 'Subclass'], index_col=False)
print(f'We start with {len(df)} sequences from table 14E')
...
filepath = 'Predictions_DAR_subclass.csv'
np.savetxt(filepath, a, delimiter=",", fmt='%.3e')
filepath = 'Targets_DAR_subclass.csv'
