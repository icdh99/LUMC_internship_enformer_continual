...
filepath = 'Predictions_test_DAR_aclevel.csv'
np.savetxt(filepath, a, delimiter=",", fmt='%.3e')
filepath = 'Targets_test_DAR_aclevel.csv'
...
df.to_csv('/exports/humgen/idenhond/projects/dar/correlation_per_DAR/AC-level/Correlation_test_DAR_aclevel.csv')
