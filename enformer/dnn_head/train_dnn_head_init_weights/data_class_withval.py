...
class MyDataset_train(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = torch.load(f'/exports/archive/hg-funcgenom-research/idenhond/Enformer_train/Enformer_train_targets/targets_seq{ID}.pt', map_location=torch.device('cpu')) # stored at archive
        y = torch.squeeze(y)
        return x, y
