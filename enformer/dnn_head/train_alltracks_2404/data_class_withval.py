...
class MyDataset_train(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y_newtracks = torch.load(f'/exports/humgen/idenhond/data/Enformer_train/Newtracks_2404_train_targets/targets_seq{ID}.pt', map_location=torch.device('cpu')).squeeze() #TODO
...
class MyDataset_val(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y_newtracks = torch.load(f'/exports/humgen/idenhond/data/Enformer_validation/Newtracks_2404_validation_targets/targets_seq{ID}.pt', map_location=torch.device('cpu')).squeeze() #TODO
        y = torch.cat((y_oldtracks, y_newtracks), dim = 1)
        return x, y
