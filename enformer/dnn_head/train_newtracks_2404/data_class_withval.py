...
class MyDataset_train(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = torch.load(f'/exports/humgen/idenhond/data/Enformer_train/Newtracks_2404_train_targets/targets_seq{ID}.pt', map_location=torch.device('cpu')) #TODO
        y = torch.squeeze(y)
        return x, y
...
class MyDataset_val(Dataset):
    ...
    def __getitem__(self, index):
        ...
        y = torch.load(f'/exports/humgen/idenhond/data/Enformer_validation/Newtracks_2404_validation_targets/targets_seq{ID}.pt', map_location=torch.device('cpu')) #TODO
        y = torch.squeeze(y)
        return x, y
