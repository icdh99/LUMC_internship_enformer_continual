...
path = '/exports/humgen/idenhond/projects/enformer/dnn_head/train_newtracks_newmodel_0205/model_2023-05-03 06:18:09.596212/epoch=5-step=1596-val_loss=0.8.ckpt'
print(path)
...
def compute_correlation(model, organism:str="human", subset:str=subset, max_steps=max_steps):
  ...
  for i,batch in enumerate(tqdm(dl, total=n_steps)):
    ...
    #   print(f'pred shape: {pred.shape}')
      # if subset == 'train': torch.save(pred, f'/exports/humgen/idenhond/data/Enformer_train/Enformer_train_output_newtracks_newmodel_0205/output_seq{i+1}.pt')
      if subset == 'test': torch.save(pred, f'/exports/humgen/idenhond/data/Enformer_test/Enformer_test_output_newtracks_newmodel_0205/output_seq{i+1}.pt')
      # if subset == 'valid': torch.save(pred, f'/exports/humgen/idenhond/data/Enformer_validation/Enformer_validation_output_newtracks_newmodel_0205/output_seq{i+1}.pt')
...
# BESTANDSNAAM AANPASSEN
  ...
  df.to_csv(f"/exports/humgen/idenhond/data/evaluate_correlation/correlation_per_track_{subset}_newtracks_newmodel_0205.csv",index=True)
